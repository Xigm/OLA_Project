...
class GTS_Learner(Learner):
    def __init__(self, n_arms):
        ...
        self.sigmas = np.ones(n_arms)*1e3 #in the beggining since we have not any info on the arms we assume that all the arms have an high probability to be pulled
