...
n_obs = 50
bids = np.linspace(0.0, 1.0, 20) #genera una sequenza di valori equidistanti nell'intervallo specificato (20 numeri tra 0 e 1 equidistanti)
x_obs = np.array([])
y_obs = np.array([])
...
for i in range(0, n_obs):
    ...
    # usually we need to normalize the value but in this case we have already values between 0 and 1
