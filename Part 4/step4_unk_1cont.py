# -*- coding: utf-8 -*-
"""
Created on Fri Jul 21 18:59:11 2023
...
gpts_rewards_per_experiment1 = pad_arrays_with_mean(gpts_last_arrays1)
gpts_rewards_per_experiment2 = pad_arrays_with_mean(gpts_last_arrays2)
gpts_rewards_per_experiment3 = pad_arrays_with_mean(gpts_last_arrays3)

# Pad the arrays with the mean for GP-UCB rewards
gpucb_rewards_per_experiment1 = pad_arrays_with_mean(gpucb_last_arrays1)
gpucb_rewards_per_experiment2 = pad_arrays_with_mean(gpucb_last_arrays2)
gpucb_rewards_per_experiment3 = pad_arrays_with_mean(gpucb_last_arrays3)

# ... (rest of the code remains the same)


gpts_rewards_per_experiment1 = pad_arrays(gpts_rewards_per_experiment1)
gpts_rewards_per_experiment2 = pad_arrays(gpts_rewards_per_experiment2)


gpucb_rewards_per_experiment1 = pad_arrays(gpucb_rewards_per_experiment1)
gpucb_rewards_per_experiment2 = pad_arrays(gpucb_rewards_per_experiment2)
